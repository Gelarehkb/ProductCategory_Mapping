...
export const masterCategories: CategoryNode[] = [
  {
    ...
    children: [
      ...
      { name: "Babys erste Kleidung", children: [
        ...
        { name: "Bodies" }, { name: "Jäckchen & Pullis" }, { name: "Mützchen & Füßlinge" },
      ...
      { name: "Für Mamas", children: [
        { name: "Baby Geschenke" }, { name: "Babytragen" }, { name: "Deko" },
        { name: "Gutscheine" }, { name: "Im Urlaub" },
  ...
  },
  {
    name: "Back to School",
    children: [
      { name: "Buchstaben Spaß" }, { name: "Für die Schultüte" },
      { name: "Kinderschreibtische & Stühle" }, { name: "Klein-Aufbewahrung" },
      { name: "Lederhausschuhe" }, { name: "Regen- & Outdoorkleidung" },
      { name: "Rucksäcke & Turnbeutel" }, { name: "Schüttelpenale" },
      { name: "Trinkflaschen & Jausenboxen" },
    ],
  },
  {
    name: "Bio-Basics & Wollfleece",
    children: [
      { name: "Basics 0 bis 4 J" }, { name: "Frühchen" },
      { name: "Für Mamas" }, { name: "Wollfleece" },
    ],
  },
  {
    name: "Bücher & Tonies",
  ...
  },
  {
    name: "Frühling",
    children: [
      { name: "Badeurlaub mit Kindern" }, { name: "Essenszeit" },
      { name: "Frühlingsmode" }, { name: "Im Frühling Unterwegs" },
      { name: "Ostern", children: [
        { name: "Alles Hase" }, { name: "Klettern/Rutschen/Schaukeln" },
        { name: "Laufräder & Dreiräder" }, { name: "Oster Specials" },
        { name: "Ostereier" }, { name: "Osterkörbchen" }, { name: "Puppenwelt" },
        { name: "Rollenspiele" }, { name: "Tipis & Co." },
      ]},
      { name: "Rund ums Schlafen" },
      { name: "Zimmer dekorieren", children: [{ name: "Schlaf gut, Baby" }] },
      { name: "Zum Muttertag" }, { name: "Übergangskleidung" },
    ],
  },
  {
    name: "Gutscheine",
  ...
  },
  {
    name: "Herbst",
    children: [
      { name: "Bio-Wollfleece" }, { name: "Herbstmode" },
      { name: "Im Herbst Unterwegs", children: [
        { name: "Babytragen & Wickeltaschen" }, { name: "Kinderwagen & Buggys" },
        { name: "Laufräder & Dreiräder" }, { name: "Regenkleidung" },
        { name: "Rucksäcke" }, { name: "Trinken & Essen To Go" },
      ]},
      { name: "Indoor Spielen", children: [
        { name: "Krabbelsocken" }, { name: "Lederhausschuhe" },
        { name: "Spielmatten & Tipis" },
      ]},
      { name: "Mein Zimmer Einrichten", children: [
        { name: "Kindermöbel Bestseller" }, { name: "Kinderschreibtische" },
        { name: "Klein-Aufbewahrung" }, { name: "Lampen & Nachtlichter" },
        { name: "Teppiche" }, { name: "Zimmer Deko" },
      ]},
      { name: "Schlaf Gut Baby", children: [
        { name: "Decken" }, { name: "Kuscheltiere" }, { name: "Nestchen" },
        { name: "Pyjamas" }, { name: "Schlafsäcke" },
      ]},
    ],
  },
  {
    ...
    children: [
      { name: "Fürs Badezimmer", children: [
        { name: "Bademäntel & Handtücher" }, { name: "Klein Aufbewahrung" },
      ...
      { name: "Rund ums Schlafen", children: [
        { name: "Babydecken" }, { name: "Babynestchen" },
        { name: "Babyschlafsäcke" }, { name: "Bettwäsche" },
      ]},
  ...
  },
  {
    name: "Kassenartikel",
    children: [
      { name: "2" }, { name: "3" }, { name: "4" }, { name: "alle" },
    ],
  },
  {
    name: "Kinderwagen",
    children: [
      ...
      { name: "JOOLZ", children: [
        { name: "Aer 2" }, { name: "Aer/Aer+" }, { name: "Day 5" },
        { name: "Geo 3" }, { name: "Hub 2" }, { name: "Zubehör" },
      ]},
      { name: "Kinderautositze", children: [
        { name: "CYBEX" }, { name: "DOONA" }, { name: "MAXI COSI" }, { name: "THULE" },
      ]},
      { name: "MAXI COSI", children: [
        { name: "Autositze" }, { name: "Fame" },
      ]},
      { name: "NATURKIND", children: [
        { name: "Ida" }, { name: "Lars" }, { name: "Lux Evo" },
        { name: "Mads" }, { name: "Zubehör" },
      ]},
      { name: "STOKKE", children: [
        { name: "YOYO³" }, { name: "Zubehör" },
      ]},
      { name: "TERNX" },
      { name: "THULE", children: [
      ...
      { name: "Zubehör", children: [
        { name: "BABYJOGGER Zubehör" }, { name: "Fuß- & Fellsäcke" },
        { name: "Matratzen" }, { name: "PHIL & TEDS Zubehör" },
  ...
  },
  {
    name: "Marken",
    children: [
      { name: "#", children: [{ name: "1+ IN THE FAMILY" }] },
      { name: "A", children: [
        { name: "AIGLE" }, { name: "AMBOSSTOYS" }, { name: "ANNETTE BETZ" },
        { name: "ARS" }, { name: "ARS EDITION" },
      ]},
      { name: "Aussteller SALE" },
      { name: "B", children: [
        { name: "BABYLONIA" }, { name: "BABYSHOWER" }, { name: "BABYZEN" },
      ]},
    ],
  },
  {
    ...
    children: [
      ...
      { name: "Kindermode 0 bis 5J", children: [
        { name: "Bio-Basics" }, { name: "Bodies" }, { name: "Hauben & Füßlinge" },
      ...
      { name: "Schuhe", children: [
        { name: "Babyschuhe" }, { name: "Lederhausschuhe" },
        { name: "Sandalen" }, { name: "Stiefel" },
      ]},
    ],
  },
  {
    ...
    children: [
      { name: "Babyzimmer", children: [
        { name: "Babybetten" }, { name: "Babywippen & Hochstühle" },
        { name: "Betthimmel" }, { name: "Mobile & Spieluhren" }, { name: "Nestchen" },
      ...
      { name: "Kinderzimmer Inspiration", children: [
        { name: "blau" }, { name: "rose" }, { name: "Leander Bett pflaume" },
        { name: "My Castle" }, { name: "Schlaf Gut Baby" },
        { name: "Wickelecke grün" }, { name: "Wickelecke rose" },
      ]},
      { name: "Möbel Aktion" }, { name: "Möbel für Große" },
      { name: "Rund ums Schlafen", children: [
        { name: "Babyschlafsäcke" }, { name: "Bettwäsche" },
        { name: "Decken" }, { name: "Nestchen" },
      ]},
      { name: "Wandfarbe, Lack & Tapete", children: [
        { name: "Lack auf Wasserbasis" }, { name: "Tapeten & Wandsticker" },
  ...
  {
    name: "Schenken Tut Gut",
    children: [
      { name: "Für Abenteuer", children: [{ name: "drinnen oder draußen" }] },
  ...
  },
  {
    name: "Sommer",
    children: [
      { name: "Bademode & UV-Schutz" }, { name: "Im Sommer Unterwegs" },
      { name: "Reisebetten" }, { name: "Sand & Wasserspielzeug" }, { name: "Sommermode" },
    ],
  },
  {
    name: "Spielen",
    children: [
      { name: "Baby Spielsachen", children: [
        { name: "Badespielzeug" }, { name: "Beißringe & Rasseln" },
        { name: "Schmusetücher" }, { name: "Spielbögen & Spielmatten" },
        { name: "Spieluhren & Mobile" }, { name: "Wagen- & Schnullerketten" },
      ]},
      { name: "Bücher", children: [
        { name: "Bilderbücher" }, { name: "Buch mit CD" }, { name: "Kinderbücher" },
        { name: "Liederbücher" }, { name: "Mal- und Bastelbücher" }, { name: "Ratgeber" },
        { name: "Sachbücher" }, { name: "Schwangerschaft" }, { name: "Vorlesen & selber lesen" },
      ]},
      ...
      { name: "Spielen nach Alter", children: [
        { name: "bis 6 Monate" }, { name: "3" }, { name: "6" },
        { name: "12" }, { name: "24" }, { name: "5+ Jahre" },
      ]},
  ...
  },
  {
    name: "Versand",
    children: [
      { name: "Noch nicht zugeordnet" }, { name: "Service & Dienstleistungen" },
    ],
  },
  {
    name: "Winter",
    children: [
      ...
      { name: "Im Winter Unterwegs", children: [
        { name: "Auf Rädern" }, { name: "Fuß- & Fellsäcke" },
        { name: "Kinderwagen & Autositze" }, { name: "Trinken & Essen To Go" },
        { name: "Wickeltaschen & Rucksäcke" }, { name: "Winterkleidung" }, { name: "Wolle" },
      ]},
      { name: "Indoor Spielen", children: [
        { name: "24" }, { name: "3" }, { name: "5+ Jahre" },
        { name: "Krabbelmatten & Spielbögen" }, { name: "Krabbelsocken & Lederpatschen" },
        { name: "Rutschen/Schaukeln/Verstecken" }, { name: "Stofftiere" },
      ]},
      { name: "Mein Zimmer einrichten", children: [
        { name: "Beleuchtung" }, { name: "Kindermöbel Bestseller" },
        { name: "Klein-Aufbewahrung" }, { name: "Spieluhren & Mobile" },
        { name: "Teppiche" }, { name: "Zimmer Deko" },
      ]},
      { name: "Schlaf gut Baby", children: [
        { name: "Bettwäsche" }, { name: "Kuscheln" }, { name: "Nachtlichter" },
        { name: "Nestchen & Decken" }, { name: "Pyjamas" }, { name: "Schlafsäcke" },
      ]},
    ],
  },
  {
    ...
    children: [
      ...
      { name: "Im Winter unterwegs", children: [
        { name: "Fellsäcke & Fußsäcke" }, { name: "Mützen/Handschuhe/Schals" },
        { name: "Trinken & Essen To Go" }, { name: "Wickeltaschen & Rucksäcke" },
        { name: "Winterbekleidung" },
      ]},
      { name: "Mein Zimmer einrichten", children: [
        { name: "Beleuchtung" }, { name: "Kindermöbel Bestseller" },
        { name: "Klein-Aufbewahrung" }, { name: "Spieluhren & Mobile" }, { name: "Zimmer Deko" },
      ]},
      { name: "Motorik- & Bewegungsspiele", children: [
        { name: "Krabbelmatten & Spielbögen" }, { name: "Krabbelsocken & Lederpatschen" },
      ]},
      { name: "Schenken tut gut", children: [
        { name: "Für Abenteuer" }, { name: "Für Fantasie/Geschichten/Weltenbauer" },
        { name: "Für Kinder die schon (fast) alles haben" }, { name: "Für kleine Rituale" },
      ]},
      { name: "Schlaf gut Baby", children: [
        { name: "Bettwäsche" }, { name: "Kuscheln" }, { name: "Nestchen & Decken" },
        { name: "Pyjamas" }, { name: "Schlafsäcke" },
      ]},
      { name: "Spielen nach Alter", children: [
        { name: "bis 6 Monate" }, { name: "6-12 Monate" }, { name: "12" },
        { name: "12-24 Monate" }, { name: "24" }, { name: "24-36 Monate" },
        { name: "3" }, { name: "5+ Jahre" }, { name: "6" },
      ]},
...
/** Build a path string like "Babyausstattung -> Baby Geschenke -> Beißringe & Rasseln" */
